...
public class ClusterConfig extends PluginProfile {

    public ClusterConfig() {
        super();
    }

    public ClusterConfig(String id, String pluginId, ConfigurationProperty... props) {
        super(id, pluginId, props);
    }

    public ClusterConfig(String id, String pluginId, Collection<ConfigurationProperty> configProperties) {
