...
public class ElasticConfig {
    ...
    @ConfigSubtag
    private ClusterConfigs clusters = new ClusterConfigs();
    ...
    public ClusterConfigs getClusters() {
        return clusters;
    }

    public void setClusters(ClusterConfigs clusters) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(jobStarvationTimeout, profiles, clusters);
    }
}
