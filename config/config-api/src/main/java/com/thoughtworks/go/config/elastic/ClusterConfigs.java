...
@ConfigTag("clusters")
@ConfigCollection(ClusterConfig.class)
public class ClusterConfigs extends PluginProfiles<ClusterConfig> implements Validatable {
    private final ConfigErrors errors = new ConfigErrors();

    public ClusterConfigs() {
    }

    public ClusterConfigs(ClusterConfig... clusters) {
