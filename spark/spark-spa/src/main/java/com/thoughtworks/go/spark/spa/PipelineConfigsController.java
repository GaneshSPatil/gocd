...
public class PipelineConfigsController implements SparkController {
    ...
    public void setupRoutes() {
        path(controllerBasePath(), () -> {
            ...
            get(Routes.PipelineConfig.NAME, this::show, engine);
        });
    }

    private ModelAndView show(Request request, Response response) {
        Map<Object, Object> object = new HashMap<Object, Object>() {{
            put("viewTitle", "PipelineConfigs edit");
        }};
